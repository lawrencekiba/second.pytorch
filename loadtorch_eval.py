'''This code is meant to isolate the evaluation part of the PointPillars, loading trained model & performed evaluation on the data. Usage is as follows.

1. Train using original PointPillars repo
2. Set model_dir & config_path accordingly. Don't forget to check dependencies just in case
3. python loadtorch_eval.py'''
...
config_path='/path/to/xyres_16.proto'
